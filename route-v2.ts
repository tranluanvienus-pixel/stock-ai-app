...
async function getCompanyInfo(symbol: string) {
  try {
    const modules = "assetProfile,summaryDetail,financialData,defaultKeyStatistics,recommendationTrend,price";
...
export async function POST(req: Request) {
  ...
  // After-hours từ Finnhub
  const afterHoursPrice = fq?.c && result.meta.postMarketPrice ? result.meta.postMarketPrice : undefined;
